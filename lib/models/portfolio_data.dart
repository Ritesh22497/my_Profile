...
class PortfolioData {
  ...
  static const List<ProjectModel> projects = [
    ...
    ProjectModel(
      ...
      icon: "🕉️",
      subtitle: "Video Calling & Spiritual Platform",
      description:
          "Spiritual services ecosystem supporting online/offline Pooja bookings, astrology consultations, Kundali analysis, real-time Agora SDK video calls, and e-commerce.",
      techStack: [
        "Flutter",
        "Firebase",
        "Razorpay",
      ...
      highlights: [
        "Engineered real-time 1-on-1 audio/video consultations utilizing Agora SDK.",
        "Real-time live appointment synchronization with Firebase Firestore.",
        "Google Maps API for pinpointing temple locations and home-delivery routing.",
        "E-commerce catalog for purchasing ritual samagri with Razorpay checkout.",
      ],
    ),
    ProjectModel(
      id: "day-2-day-post",
    ...
    ProjectModel(
      ...
      icon: "🤝",
      subtitle: "Priest & Astrologer Vendor Portal",
      description:
          "B2B vendor portal for priests and service providers to manage customer bookings, appointments, earnings, and live availability.",
      techStack: [
        "Flutter",
        "Provider",
        "Firebase Auth",
      ...
      highlights: [
        "Secure vendor onboarding and authentication via Firebase Auth.",
        "Real-time booking management, calendar sync, and schedule tracking.",
        "In-depth earnings dashboard with payout records.",
      ],
    ),
    ProjectModel(
      id: "hrms",
